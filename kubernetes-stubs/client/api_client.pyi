...
class ApiClient:
    ...
    def __init__(self, configuration: Incomplete | None = None, header_name: Incomplete | None = None, header_value: Incomplete | None = None, cookie: Incomplete | None = None, pool_threads: int = 1) -> None: ...
    def __enter__(self): ...
    ...
    def call_api(self, resource_path, method, path_params: Incomplete | None = None, query_params: Incomplete | None = None, header_params: Incomplete | None = None, body: Incomplete | None = None, post_params: Incomplete | None = None, files: Incomplete | None = None, response_type: Incomplete | None = None, auth_settings: Incomplete | None = None, async_req: Incomplete | None = None, _return_http_data_only: Incomplete | None = None, collection_formats: Incomplete | None = None, _preload_content: bool = True, _request_timeout: Incomplete | None = None, _host: Incomplete | None = None): ...
    def request(self, method, url, query_params: Incomplete | None = None, headers: Incomplete | None = None, post_params: Incomplete | None = None, body: Incomplete | None = None, _preload_content: bool = True, _request_timeout: Incomplete | None = None): ...
