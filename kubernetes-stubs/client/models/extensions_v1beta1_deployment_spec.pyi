...
class ExtensionsV1beta1DeploymentSpec:
    ...
    discriminator: Any = ...
    def __init__(self, min_ready_seconds: Optional[Any] = ..., paused: Optional[Any] = ..., progress_deadline_seconds: Optional[Any] = ..., replicas: Optional[Any] = ..., revision_history_limit: Optional[Any] = ..., rollback_to: Optional[Any] = ..., selector: Optional[Any] = ..., strategy: Optional[Any] = ..., template: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
