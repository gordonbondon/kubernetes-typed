...
class V1APIGroup:
    ...
    def __init__(self, api_version: Incomplete | None = None, kind: Incomplete | None = None, name: Incomplete | None = None, preferred_version: Incomplete | None = None, server_address_by_client_cid_rs: Incomplete | None = None, versions: Incomplete | None = None, local_vars_configuration: Incomplete | None = None) -> None: ...
    @property
