...
class V1APIGroup:
    ...
    discriminator: Any
    def __init__(self, api_version: Any | None = ..., kind: Any | None = ..., name: Any | None = ..., preferred_version: Any | None = ..., server_address_by_client_cid_rs: Any | None = ..., versions: Any | None = ..., local_vars_configuration: Any | None = ...) -> None: ...
    @property
