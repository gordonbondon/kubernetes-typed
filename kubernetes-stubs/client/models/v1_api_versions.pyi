...
class V1APIVersions:
    ...
    discriminator: Any = ...
    def __init__(self, api_version: Optional[Any] = ..., kind: Optional[Any] = ..., server_address_by_client_cid_rs: Optional[Any] = ..., versions: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
