...
class V1AWSElasticBlockStoreVolumeSource:
    ...
    def __init__(self, fs_type: Incomplete | None = None, partition: Incomplete | None = None, read_only: Incomplete | None = None, volume_id: Incomplete | None = None, local_vars_configuration: Incomplete | None = None) -> None: ...
    @property
    def fs_type(self): ...
    @fs_type.setter
