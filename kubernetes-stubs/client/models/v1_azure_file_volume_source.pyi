...
class V1AzureFileVolumeSource:
    ...
    def __init__(self, read_only: Incomplete | None = None, secret_name: Incomplete | None = None, share_name: Incomplete | None = None, local_vars_configuration: Incomplete | None = None) -> None: ...
    @property
    def read_only(self): ...
    @read_only.setter
