...
class V1CinderVolumeSource:
    ...
    discriminator: Any = ...
    def __init__(self, fs_type: Optional[Any] = ..., read_only: Optional[Any] = ..., secret_ref: Optional[Any] = ..., volume_id: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
    def fs_type(self): ...
    @fs_type.setter
