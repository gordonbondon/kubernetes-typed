...
class V1CinderVolumeSource:
    ...
    def __init__(self, fs_type: Incomplete | None = None, read_only: Incomplete | None = None, secret_ref: Incomplete | None = None, volume_id: Incomplete | None = None, local_vars_configuration: Incomplete | None = None) -> None: ...
    @property
    def fs_type(self): ...
    @fs_type.setter
