...
class V1ConfigMapNodeConfigSource:
    ...
    def __init__(self, kubelet_config_key: Incomplete | None = None, name: Incomplete | None = None, namespace: Incomplete | None = None, resource_version: Incomplete | None = None, uid: Incomplete | None = None, local_vars_configuration: Incomplete | None = None) -> None: ...
    @property
