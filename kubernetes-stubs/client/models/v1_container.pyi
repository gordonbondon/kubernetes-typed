...
class V1Container:
    ...
    discriminator: Any = ...
    def __init__(self, args: Optional[Any] = ..., command: Optional[Any] = ..., env: Optional[Any] = ..., env_from: Optional[Any] = ..., image: Optional[Any] = ..., image_pull_policy: Optional[Any] = ..., lifecycle: Optional[Any] = ..., liveness_probe: Optional[Any] = ..., name: Optional[Any] = ..., ports: Optional[Any] = ..., readiness_probe: Optional[Any] = ..., resources: Optional[Any] = ..., security_context: Optional[Any] = ..., startup_probe: Optional[Any] = ..., stdin: Optional[Any] = ..., stdin_once: Optional[Any] = ..., termination_message_path: Optional[Any] = ..., termination_message_policy: Optional[Any] = ..., tty: Optional[Any] = ..., volume_devices: Optional[Any] = ..., volume_mounts: Optional[Any] = ..., working_dir: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
    def args(self): ...
    @args.setter
