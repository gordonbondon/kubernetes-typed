...
class V1CSIVolumeSource:
    ...
    def __init__(self, driver: Incomplete | None = None, fs_type: Incomplete | None = None, node_publish_secret_ref: Incomplete | None = None, read_only: Incomplete | None = None, volume_attributes: Incomplete | None = None, local_vars_configuration: Incomplete | None = None) -> None: ...
    @property
    def driver(self): ...
    @driver.setter
