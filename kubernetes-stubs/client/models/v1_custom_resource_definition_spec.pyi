...
class V1CustomResourceDefinitionSpec:
    ...
    discriminator: Any
    def __init__(self, conversion: Any | None = ..., group: Any | None = ..., names: Any | None = ..., preserve_unknown_fields: Any | None = ..., scope: Any | None = ..., versions: Any | None = ..., local_vars_configuration: Any | None = ...) -> None: ...
    @property
    def conversion(self): ...
    @conversion.setter
