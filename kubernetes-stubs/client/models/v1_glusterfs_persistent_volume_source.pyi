...
class V1GlusterfsPersistentVolumeSource:
    ...
    def __init__(self, endpoints: Incomplete | None = None, endpoints_namespace: Incomplete | None = None, path: Incomplete | None = None, read_only: Incomplete | None = None, local_vars_configuration: Incomplete | None = None) -> None: ...
    @property
    def endpoints(self): ...
    @endpoints.setter
