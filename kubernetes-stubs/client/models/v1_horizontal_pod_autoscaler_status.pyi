...
class V1HorizontalPodAutoscalerStatus:
    ...
    discriminator: Any
    def __init__(self, current_cpu_utilization_percentage: Any | None = ..., current_replicas: Any | None = ..., desired_replicas: Any | None = ..., last_scale_time: Any | None = ..., observed_generation: Any | None = ..., local_vars_configuration: Any | None = ...) -> None: ...
    @property
