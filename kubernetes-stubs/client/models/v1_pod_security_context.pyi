...
class V1PodSecurityContext:
    ...
    discriminator: Any
    def __init__(self, fs_group: Any | None = ..., run_as_group: Any | None = ..., run_as_non_root: Any | None = ..., run_as_user: Any | None = ..., se_linux_options: Any | None = ..., supplemental_groups: Any | None = ..., sysctls: Any | None = ..., windows_options: Any | None = ..., local_vars_configuration: Any | None = ...) -> None: ...
    @property
    def fs_group(self): ...
    @fs_group.setter
