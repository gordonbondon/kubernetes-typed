...
class V1PolicyRule:
    ...
    def __init__(self, api_groups: Incomplete | None = None, non_resource_ur_ls: Incomplete | None = None, resource_names: Incomplete | None = None, resources: Incomplete | None = None, verbs: Incomplete | None = None, local_vars_configuration: Incomplete | None = None) -> None: ...
    @property
    def api_groups(self): ...
    @api_groups.setter
