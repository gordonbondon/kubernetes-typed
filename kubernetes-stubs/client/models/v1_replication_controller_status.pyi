...
class V1ReplicationControllerStatus:
    ...
    discriminator: Any
    def __init__(self, available_replicas: Any | None = ..., conditions: Any | None = ..., fully_labeled_replicas: Any | None = ..., observed_generation: Any | None = ..., ready_replicas: Any | None = ..., replicas: Any | None = ..., local_vars_configuration: Any | None = ...) -> None: ...
    @property
