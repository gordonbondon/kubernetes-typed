...
class V1ServiceSpec:
    ...
    discriminator: Any
    def __init__(self, cluster_ip: Any | None = ..., external_i_ps: Any | None = ..., external_name: Any | None = ..., external_traffic_policy: Any | None = ..., health_check_node_port: Any | None = ..., ip_family: Any | None = ..., load_balancer_ip: Any | None = ..., load_balancer_source_ranges: Any | None = ..., ports: Any | None = ..., publish_not_ready_addresses: Any | None = ..., selector: Any | None = ..., session_affinity: Any | None = ..., session_affinity_config: Any | None = ..., topology_keys: Any | None = ..., type: Any | None = ..., local_vars_configuration: Any | None = ...) -> None: ...
    @property
    def cluster_ip(self): ...
    @cluster_ip.setter
