...
class V1SubjectAccessReviewSpec:
    ...
    discriminator: Any
    def __init__(self, extra: Any | None = ..., groups: Any | None = ..., non_resource_attributes: Any | None = ..., resource_attributes: Any | None = ..., uid: Any | None = ..., user: Any | None = ..., local_vars_configuration: Any | None = ...) -> None: ...
    @property
    def extra(self): ...
    @extra.setter
