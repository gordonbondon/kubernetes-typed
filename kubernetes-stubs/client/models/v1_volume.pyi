...
class V1Volume:
    ...
    discriminator: Any
    def __init__(self, aws_elastic_block_store: Any | None = ..., azure_disk: Any | None = ..., azure_file: Any | None = ..., cephfs: Any | None = ..., cinder: Any | None = ..., config_map: Any | None = ..., csi: Any | None = ..., downward_api: Any | None = ..., empty_dir: Any | None = ..., fc: Any | None = ..., flex_volume: Any | None = ..., flocker: Any | None = ..., gce_persistent_disk: Any | None = ..., git_repo: Any | None = ..., glusterfs: Any | None = ..., host_path: Any | None = ..., iscsi: Any | None = ..., name: Any | None = ..., nfs: Any | None = ..., persistent_volume_claim: Any | None = ..., photon_persistent_disk: Any | None = ..., portworx_volume: Any | None = ..., projected: Any | None = ..., quobyte: Any | None = ..., rbd: Any | None = ..., scale_io: Any | None = ..., secret: Any | None = ..., storageos: Any | None = ..., vsphere_volume: Any | None = ..., local_vars_configuration: Any | None = ...) -> None: ...
    @property
