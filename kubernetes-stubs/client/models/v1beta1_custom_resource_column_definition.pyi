...
class V1beta1CustomResourceColumnDefinition:
    ...
    discriminator: Any = ...
    def __init__(self, json_path: Optional[Any] = ..., description: Optional[Any] = ..., format: Optional[Any] = ..., name: Optional[Any] = ..., priority: Optional[Any] = ..., type: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
    def json_path(self): ...
    @json_path.setter
