...
class V1beta1DaemonSetSpec:
    ...
    discriminator: Any = ...
    def __init__(self, min_ready_seconds: Optional[Any] = ..., revision_history_limit: Optional[Any] = ..., selector: Optional[Any] = ..., template: Optional[Any] = ..., template_generation: Optional[Any] = ..., update_strategy: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
