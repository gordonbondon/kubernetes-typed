...
class V1beta1MutatingWebhook:
    ...
    discriminator: Any
    def __init__(self, admission_review_versions: Any | None = ..., client_config: Any | None = ..., failure_policy: Any | None = ..., match_policy: Any | None = ..., name: Any | None = ..., namespace_selector: Any | None = ..., object_selector: Any | None = ..., reinvocation_policy: Any | None = ..., rules: Any | None = ..., side_effects: Any | None = ..., timeout_seconds: Any | None = ..., local_vars_configuration: Any | None = ...) -> None: ...
    @property
