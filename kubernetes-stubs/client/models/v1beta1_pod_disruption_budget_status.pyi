...
class V1beta1PodDisruptionBudgetStatus:
    ...
    discriminator: Any
    def __init__(self, current_healthy: Any | None = ..., desired_healthy: Any | None = ..., disrupted_pods: Any | None = ..., disruptions_allowed: Any | None = ..., expected_pods: Any | None = ..., observed_generation: Any | None = ..., local_vars_configuration: Any | None = ...) -> None: ...
    @property
