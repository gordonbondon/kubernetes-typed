...
class V1beta1SubjectAccessReviewSpec:
    ...
    def __init__(self, extra: Incomplete | None = None, group: Incomplete | None = None, non_resource_attributes: Incomplete | None = None, resource_attributes: Incomplete | None = None, uid: Incomplete | None = None, user: Incomplete | None = None, local_vars_configuration: Incomplete | None = None) -> None: ...
    @property
    def extra(self): ...
    @extra.setter
