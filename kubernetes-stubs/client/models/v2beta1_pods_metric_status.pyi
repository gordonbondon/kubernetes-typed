...
class V2beta1PodsMetricStatus:
    ...
    def __init__(self, current_average_value: Incomplete | None = None, metric_name: Incomplete | None = None, selector: Incomplete | None = None, local_vars_configuration: Incomplete | None = None) -> None: ...
    @property
