...
class V2beta2HorizontalPodAutoscalerSpec:
    ...
    discriminator: Any
    def __init__(self, behavior: Any | None = ..., max_replicas: Any | None = ..., metrics: Any | None = ..., min_replicas: Any | None = ..., scale_target_ref: Any | None = ..., local_vars_configuration: Any | None = ...) -> None: ...
    @property
    def behavior(self): ...
    @behavior.setter
