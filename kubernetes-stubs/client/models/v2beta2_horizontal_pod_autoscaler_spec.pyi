...
class V2beta2HorizontalPodAutoscalerSpec:
    ...
    def __init__(self, behavior: Incomplete | None = None, max_replicas: Incomplete | None = None, metrics: Incomplete | None = None, min_replicas: Incomplete | None = None, scale_target_ref: Incomplete | None = None, local_vars_configuration: Incomplete | None = None) -> None: ...
    @property
    def behavior(self): ...
    @behavior.setter
