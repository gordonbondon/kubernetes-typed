...
class V2beta2MetricValueStatus:
    ...
    def __init__(self, average_utilization: Incomplete | None = None, average_value: Incomplete | None = None, value: Incomplete | None = None, local_vars_configuration: Incomplete | None = None) -> None: ...
    @property
