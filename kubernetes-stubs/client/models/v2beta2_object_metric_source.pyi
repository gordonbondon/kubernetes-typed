...
class V2beta2ObjectMetricSource:
    ...
    def __init__(self, described_object: Incomplete | None = None, metric: Incomplete | None = None, target: Incomplete | None = None, local_vars_configuration: Incomplete | None = None) -> None: ...
    @property
