...
class VersionInfo:
    ...
    discriminator: Any = ...
    def __init__(self, build_date: Optional[Any] = ..., compiler: Optional[Any] = ..., git_commit: Optional[Any] = ..., git_tree_state: Optional[Any] = ..., git_version: Optional[Any] = ..., go_version: Optional[Any] = ..., major: Optional[Any] = ..., minor: Optional[Any] = ..., platform: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
    def build_date(self): ...
    @build_date.setter
