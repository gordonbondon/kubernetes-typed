...
class VersionInfo:
    ...
    discriminator: Any
    def __init__(self, build_date: Any | None = ..., compiler: Any | None = ..., git_commit: Any | None = ..., git_tree_state: Any | None = ..., git_version: Any | None = ..., go_version: Any | None = ..., major: Any | None = ..., minor: Any | None = ..., platform: Any | None = ..., local_vars_configuration: Any | None = ...) -> None: ...
    @property
    def build_date(self): ...
    @build_date.setter
